...
#define BOWSER_FB_RAM_SIZE                SZ_40M
...
static struct omap_dss_device bowser_lcd_device = {
	...
	.clocks = {
		...
		.dsi = {
			...
			.regm           = 363,	/* DSI_PLL_REGM */
			.regm_dispc     = 12,	/* PLL_CLK1 (M4) */
			.regm_dsi       = 10,	/* PLL_CLK2 (M5) */
			.lp_clk_div     = 18,	/* PLDIV */
			.offset_ddr_clk = 0,
			.dsi_fclk_src   = OMAP_DSS_CLK_SRC_DSI_PLL_HSDIV_DSI,
		},
...
int __init bowser_panel_init(void)
{
	...
	omap_vram_set_sdram_vram(SZ_64M, 0);
