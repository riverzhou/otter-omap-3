...
#ifdef CONFIG_OTTER
#define OMAP_RAM_CONSOLE_START_DEFAULT	(PLAT_PHYS_OFFSET + (SZ_1M * 400))
#define OMAP_RAM_CONSOLE_SIZE_DEFAULT	SZ_4K
#else
#define OMAP_RAM_CONSOLE_START_DEFAULT	(PLAT_PHYS_OFFSET + (SZ_1M * 906))
#define OMAP_RAM_CONSOLE_SIZE_DEFAULT	SZ_256K
#endif
