		...
		struct cpufreq_policy *policy)
{
	...
	TRAPZ_DESCRIBE(TRAPZ_KERN_CPUFREQ, PerfactiveSwitchMode,
			"cpufreq perfactive governor: switch governor mode");
	TRAPZ_LOG_PRINTF(TRAPZ_LOG_DEBUG, 0, TRAPZ_KERN_CPUFREQ, PerfactiveSwitchMode,
			"switching to mode %d %d", mode, 0);
...
static void store_video_hint(struct cpufreq_policy *policy, unsigned int hint)
{
	...
	TRAPZ_DESCRIBE(TRAPZ_KERN_CPUFREQ, PerfactiveVideoHint,
			"cpufreq perfactive governor: video hint");
	TRAPZ_LOG_PRINTF(TRAPZ_LOG_DEBUG, 0, TRAPZ_KERN_CPUFREQ, PerfactiveVideoHint,
			"video hint %d %d", hint, 0);
...
static void store_panel_hint(struct cpufreq_policy *policy, unsigned int hint)
{
	...
	TRAPZ_DESCRIBE(TRAPZ_KERN_CPUFREQ, PerfactivePanelHint,
			"cpufreq perfactive governor: panel hint");
	TRAPZ_LOG_PRINTF(TRAPZ_LOG_DEBUG, 0, TRAPZ_KERN_CPUFREQ, PerfactivePanelHint,
			"panel hint %d %d", hint, 0);
