...
/*
#include "lsrs_mux_pps_driver.h"
#include "second_pps_driver.h"
*/
#include "loud_srs_pps_driver.h"
/* #include  "loud_srs_hsbypass.h" */
/*include "spkr-basic-pps.h"*/
#include "hp-basic-pfw.h"
#include "second_pps_driver.h"
/* defines */
...
#define PROGRAM_CODEC_REG_POST_SECTIONS
#define ADD_MINI_DSP_CONTROLS
#define USE_MUX_CONTROLS
/* #define USE_VOLUME_CONTROLS */
...
/*MiniDSP process flow configurations*/
typedef struct {
	string * reg_section_name;
	reg_value * reg_section_program;
	reg_value * reg_section_values_a_reg;
	reg_value * reg_section_values_d_reg;
	control *mux_ctl;
	string  *mux_ctl_name;
	control *vol_ctl;
	string  *vol_ctl_name;
	unsigned int size_of_reg_section_name;
	unsigned int size_of_reg_section_program;
	unsigned int size_of_values_a_reg;
	unsigned int size_of_values_d_reg;
	unsigned int size_of_mux_ctl;
	unsigned int size_of_mux_ctl_name;
	unsigned int size_of_vol_ctl;
	unsigned int size_of_vol_ctl_name;

} minidsp_config_sections;
